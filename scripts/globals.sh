...
function set_globals() {
  ...
  #=============== AİKLIPPERSCREEN ================#
  AiKLIPPERSCREEN_ENV="${HOME}/.AiKlipperScreen-env"
  AiKLIPPERSCREEN_DIR="${HOME}/AiKlipperScreen"
  AiKLIPPERSCREEN_REPO="https://github.com/AiScreen/AiKlipperScreen.git"
